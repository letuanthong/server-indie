...
public class ConstNpc {
        ...
        public static final String HUONG_DAN_BLACK_BALL_WAR = """
                ...
                1 sao đen: +21% sức đánh 
                2 sao đen: +35% HP
                3 sao đen: Biến 35% tấn công thành HP 
                4 sao đen: Phản 35% sát thương 
                5 sao đen: 35% Sức đánh chí mạng 
                6 sao đen: KI+40% 
                7 sao đen: 14% Né đòn
                Hết rồi không còn gì nữa đâu""";
        public static final String HUONG_DAN_MAP_MA_BU = """
                Tại khu vực này, ta đã dùng ma pháp phong ấn
                dù các ngươi có mạnh đến đâu cũng sẽ trở thành yếu đuối như nhau
                Chỉ có ta với con nhóc Ôsin mới giải được ma pháp này
                Khi đó sức mạnh của ngươi sẽ được giải phóng theo điểm tích lũy (TL)
                Khi đủ điểm tích lũy bằng cách hạ lẫn nhau hoặc hạ boss
        ...
        public static final String NPC_DHVT23 = """
                Đại hội quy tụ nhiều cao thủ như là Jacky Chun, Thiên Xin Hăng, Tàu Bảy Bảy... 
                Phần thường là 1 rương gỗ chưa nhiều vật phẩm giá trị.
                Khi hạ được 1 đối thủ, phần thưởng sẽ nâng lên 1 cấp.
                Rương càng cao cấp, vật phẩm trong đó càng giá trị hơn.
                Mỗi ngày bạn chỉ được nhận 1 phần thưởng.
                Bạn hãy cố gắng hết sức mình
                để nhận phần thưởng xứng đáng nhất nhé
                Hết rồi không còn gì nữa đâu""";

        public static final String HUONG_DAN_KHI_GAS_HUY_DIET = """
                Chúng ta gặp rắc rối rồi
                Thượng Đế nói với tôi rằng có 1 loại khí gọi là Destron Gas, thứ này không thuộc về nơi đây
                Nó tích tụ trên Trái Đất và nó sẽ hủy diệt mọi mô tế bào sống
                Có tất cả 4 địa điểm mà Thượng Đế bảo tôi nói với cậuCậu có thể đến kiểm tra...
                ...
                Thứ tư là Hành tinh Bóng Tối đang che phủ một phần địa cầuCậu đã hiểu rõ chưa?
                Hết rồi không còn gì nữa đâu""";

        public static final String HUONG_DAN_BILL = """
                Đại hội võ thuật liên vũ trụ là nơi quy tụ các cao thủ từ khắp các Vũ Trụ
                Được tổ chức hàng ngày tại các thời điểm như sau:
                Thứ 2: 6h, Thứ 3: 13h, Thứ 4: 15h, 
                Thứ 5: 17h, Thứ 6: 18h, Thứ 7: 12h, Chủ Nhật 10h
                Với các phần thưởng vô cùng hấp dẫn như sau
                Top 10: 1 phiếu giảm giá, 1 capsule Vàng
                Top 1: tặng thêm 1 Rađa cấp 13
                Phần thưởng được trao tại vũ trụ của chiến binh
                Đến gặp Whis tại vũ trụ của ngươi để nhận thưởng
                Hết rồi không còn gì nữa đâu""";

        public static final String HUONG_DAN_NRNM = """
                Để gọi được Rồng Thần Namếc, anh cần phải làm các việc sau
                1) Đang có bang hội
                2) Tập họp đủ 7 viên ngọc rồng Namếc tại đây
                3) Em sẽ gọi rồng và anh nào giữ ngọc 1 sao sẽ được chọn điều ước
                4) Thời gian gọi Rồng Thần là 8h-22h
                (Lưu ý) Điều ước sẽ có tác dụng với tất cả thành viên trong bang có mặt tại đây
                Sau khi điều ước được thực hiện, tất cả ngọc sẽ biến thành đá trong 1 ngày
                Những ai vừa nhận điều ước, hoặc bang hội nhận điều ước
                phải chờ 7 ngày sau mới có thể nhận điều ước khác
                Hết rồi không còn gì nữa đâu""";
        public static final String TAP_TU_DONG = """
                Tập luyện vẫn tiếp tục và sức mạnh vẫn tăng khi đã Offline
                ...
                Hết rồi không còn gì nữa đâu""";
        public static final String THONG_TIN_DAI_HOI_VO_THUAT = """
                ...
                Giải Ngoại hạng: 10.000 vàng
                Vô địch: 5 viên đá nâng cấp
                ...
                Hết rồi không còn gì nữa đâu""";
        public static final String THONG_TIN_SIEU_HANG = """
                ...
                Cơ cấu giải thưởng như sau(chốt và trao giải ngẫu nhiên từ 20h-23h mỗi ngày)
                Top 1 thưởng 100 ngọc
                Top 2-10 thưởng 20 ngọc
                Top 11-100 thưởng 5 ngọc
                Top 101-1000 thưởng 1 ngọc
                Mỗi ngày các bạn được tặng 1 vé tham dự miễn phí(tích lũy tối đa 3 vé) khi thua sẽ mất đi 1 vé
                Khi hết vé bạn phải trả 1 ngọc để đấu tiếp(trừ ngọc khi trận đấu kết thúc)
                Bạn không thể thi đấu với đấu thủ có hạng nhỏ hơn mình
    ...
    public static final byte EVENT = 80;
    //----------------------index menu------------------------------------------
    ...
    public static final int EVENT_3 = 3333;
    public static final int EVENT_3_1 = 3334;
