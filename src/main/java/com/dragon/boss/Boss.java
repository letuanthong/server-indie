...
import com.dragon.managers.boss.FinalBossManager;
...
public class Boss extends Player implements IBoss {
    ...
    protected void notifyJoinMap() {
        // Kiểm tra nếu tên boss là "Ăn Trộm" thì không gửi thông báo
        if (this.name.equalsIgnoreCase("Ăn Trộm")) {
            return; // Không làm gì cả, không gửi thông báo
        }

        // Nếu tên không phải là "Ăn Trộm" thì gửi thông báo bình thường
        if (canSendNotify()) {
