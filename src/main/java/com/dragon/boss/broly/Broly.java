package com.dragon.boss.broly;

import static com.dragon.consts.BossType.BROLY;
...
public class Broly extends Boss {
    ...
    public Broly() throws Exception {
        super(BROLY, BossID.BROLY, new BossData(
                ...
                generateSkills(Skill.TAI_TAO_NANG_LUONG, Skill.DRAGON, Skill.DEMON, Skill.GALICK, Skill.KAMEJOKO,
                        Skill.MASENKO, Skill.ANTOMIC),
                new String[] {},
