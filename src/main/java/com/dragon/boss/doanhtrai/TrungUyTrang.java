package com.dragon.boss.doanhtrai;

import static com.dragon.consts.BossType.PHOBANDT;
...
public class TrungUyTrang extends Boss {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(50, 100)) {
            ItemMap it = ItemMap.create(this.zone, 1560, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
