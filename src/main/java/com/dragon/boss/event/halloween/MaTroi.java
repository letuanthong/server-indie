package com.dragon.boss.event.halloween;

import static com.dragon.consts.BossType.HALLOWEEN_EVENT;
...
public class MaTroi extends Boss {
    ...
    public void reward(Player plKill) {
        ItemMap it = ItemMap.create(this.zone, 585, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
