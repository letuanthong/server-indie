package com.dragon.boss.event.hungvuong;

import static com.dragon.consts.BossType.HUNGVUONG_EVENT;
...
public class SonTinh extends Boss {
    ...
    public void afk() {
        if (playerReward.isPl() && !isReward && this.zone != null) {
            ItemMap it = ItemMap.create(this.zone, 421, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
