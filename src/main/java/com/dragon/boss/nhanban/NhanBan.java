package com.dragon.boss.nhanban;
...
import com.dragon.content.matches.PKCommeson;
...
public class NhanBan extends Boss {
    ...
    public void reward(Player plKill) {
        ItemMap it = ItemMap.create(zone, 638, 1, this.location.x, this.location.y, plKill.id);
        it.options.clear();
    ...
    public void active() {
        if (this.typePk == ConstPlayer.NON_PK) {
            PKCommeson.create(playerAtt, this);
        }
        this.attack();
    }
