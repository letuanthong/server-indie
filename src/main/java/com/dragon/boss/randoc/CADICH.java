package com.dragon.boss.randoc;

import static com.dragon.consts.BossType.PHOBANCDRD;
...
public class CADICH extends Boss {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(50, 100)) {
            ItemMap it = ItemMap.create(this.zone, 459, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
            ...
            ItemMap it2 = ItemMap.create(this.zone, 706, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
