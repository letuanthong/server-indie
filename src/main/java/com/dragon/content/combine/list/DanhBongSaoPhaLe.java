...
public class DanhBongSaoPhaLe {
    ...
    //     return switch (saoPhaLeCap1Id) {
    //         case 1416 -> 1426; // Sao pha lê đỏ
    //         case 1417 -> 1427; // Sao pha lê lam
    //         case 1418 -> 1428; // Sao pha lê hồng
    //         case 1419 -> 1429; // Sao pha lê tím
    //         case 1420 -> 1430; // Sao pha lê cam
    //         case 1421 -> 1431; // Sao pha lê vàng
    //         case 1422 -> 1432; // Sao pha lê lục
    //         default -> -1;  // Trường hợp không hợp lệ
    //     };
    // }
}
