...
public class NangChiSoBongTai {
    ...
    // private static final int RATIO_BONG_TAI = 50; thonk
    // private static final int GEM_BONG_TAI = 1_000; thonk
    ...
    public static void nangChiSoBongTai(Player player) {
        try {
            ...
            if (Util.isTrue(player.combineNew.ratioCombine, 100)) {
                ...
                byte optionid ;
                byte param ;
                if (BongTai2 != null) { //check bông tai không null
            ...
            Logger.logException(NangChiSoBongTai.class, e, "Lỗi nâng chỉ số bông tai");
        }
    }
