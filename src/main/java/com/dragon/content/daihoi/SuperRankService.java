...
import com.dragon.consts.ConstSuperRank;
...
public class SuperRankService {
    ...
    public void topList(Player player, int type) {
        ...
        try {
            ...
            Logger.logException(SuperRankService.class, e, "Lỗi gửi bảng xếp hạng siêu cấp");
        } finally {
            if (msg != null) {
                msg.cleanup();
            }
    ...
    public Zone getZone(int mapId) {
        ...
        try {
            ...
            Logger.logException(SuperRankService.class, e, "Lỗi lấy zone thi đấu siêu cấp");
        }
        return null;
    }
