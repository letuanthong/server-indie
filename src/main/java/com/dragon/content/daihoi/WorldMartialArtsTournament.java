...
import com.dragon.consts.ConstTournament;
    ...
    public void run() {
        while (!Maintenance.isRunning && competing) {
            try {
                ...
                Logger.logException(WorldMartialArtsTournament.class, e, "Lỗi trong WorldMartialArtsTournament");
                dispose();
                break;
            }
        }
            ...
            switch (timeUp) {
                ...
                case 22 -> {
                    try {
                        ...
                        DHVT match = DHVT.create(player_1, player_2);
                    } catch (Exception e) {
                        Logger.logException(WorldMartialArtsTournament.class, e, "Lỗi trong WorldMartialArtsTournament");
                        leaveMap();
                    }
