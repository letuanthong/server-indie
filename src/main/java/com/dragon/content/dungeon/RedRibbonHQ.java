package com.dragon.content.dungeon;
...
import com.dragon.boss.doanhtrai.NinjaAoTim;
import com.dragon.boss.doanhtrai.RobotVeSi;
import com.dragon.boss.doanhtrai.TrungUyThep;
import com.dragon.boss.doanhtrai.TrungUyTrang;
import com.dragon.boss.doanhtrai.TrungUyXanhLo;
...
public class RedRibbonHQ implements Runnable {
    ...
    public void run() {
        while (!Maintenance.isRunning && isOpened) {
            try {
                ...
                Logger.logException(RedRibbonHQ.class, e);
            }
        }
    }
    ...
    public ItemMap NR(Zone zone) {
        ...
        ItemMap it = ItemMap.create(zone, nr, 1, x, y, -1);
        return it;
    }
