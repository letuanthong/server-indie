...
import com.dragon.core.interfaces.INetwork;
import com.dragon.core.interfaces.IServerClose;
...
public class Network implements INetwork {
    ...
    public INetwork init() {
        try {
            ...
            Logger.errorln("[NETWORK] " + ex.toString());
        }
    ...
    public INetwork start(final int port) throws Exception {
        ...
        try {
            ...
            Logger.error("[SERVER] Error initializing server at port " + port + "\n");
            System.exit(0);
        }
        this.start = true;
        this.loopServer.start();
        Logger.success("[SERVER] Server initialized and listening on port " + this.port + "\n");
        return this;
    }
