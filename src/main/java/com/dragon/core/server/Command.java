...
import com.dragon.utils.SystemMetrics;
...
public class Command {
    ...
    private void initAdminCommands() {
        ...
        adminCommands.put("sp", player -> BrolyManager.gI().showListBoss(player));
