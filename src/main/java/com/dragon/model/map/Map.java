...
import com.dragon.content.dungeon.BlackBallWar;
import com.dragon.content.dungeon.DestronGas;
import com.dragon.content.dungeon.MajinBuu14H;
import com.dragon.content.dungeon.RedRibbonHQ;
import com.dragon.content.dungeon.SnakeWay;
import com.dragon.content.dungeon.TreasureUnderSea;
import com.dragon.managers.boss.BossManager;
import com.dragon.model.mob.Mob;
import com.dragon.model.mob.bigboss.GaChinCua;
import com.dragon.model.mob.bigboss.GauTuongCuop;
import com.dragon.model.mob.bigboss.Hirudegarn;
import com.dragon.model.mob.bigboss.NguaChinLmao;
import com.dragon.model.mob.bigboss.Piano;
import com.dragon.model.mob.bigboss.RobotBaoVe;
import com.dragon.model.mob.bigboss.VoiChinNga;
import com.dragon.model.mob.bigboss.VuaBachTuoc;
...
import com.dragon.services.dungeon.DestronGasService;
import com.dragon.services.dungeon.MajinBuu14HService;
import com.dragon.services.dungeon.MajinBuuService;
import com.dragon.services.dungeon.RedRibbonHQService;
import com.dragon.services.dungeon.SnakeWayService;
import com.dragon.services.dungeon.SuperDivineWaterService;
import com.dragon.services.dungeon.TreasureUnderSeaService;
import com.dragon.services.map.MapService;
import com.dragon.system.Template;
...
public class Map implements Runnable {
    ...
    public Map(int mapId, String mapName, byte planetId,
        ...
        this.planetName = mapId == 84 || mapId == 154 ? "Ngọc Rồng Online" : Service.gI().get_HanhTinh(planetId);
        this.tileId = tileId;
        this.bgId = bgId;
        this.bgType = bgType;
        this.type = type;
...
public void addNpc(Npc npc) {
    ...
    private void initItem() {
        for (Zone zone : zones) {
            switch (this.mapId) {
                case 21 ->
                    ItemMap.create(zone, 74, 1, 633, 315, -1);
                case 22 ->
                    ItemMap.create(zone, 74, 1, 56, 315, -1);
                case 23 ->
                    ItemMap.create(zone, 74, 1, 633, 320, -1);
                case 42 ->
                    ItemMap.create(zone, 78, 1, 70, 288, -1);
                case 43 ->
                    ItemMap.create(zone, 78, 1, 70, 264, -1);
                case 44 ->
                    ItemMap.create(zone, 78, 1, 70, 288, -1);
                case 85 -> //1 sao đen
                    ItemMap.create(zone, 372, 1, 0, 0, -1);
                case 86 -> //2 sao đen
                    ItemMap.create(zone, 373, 1, 0, 0, -1);
                case 87 -> //3 sao đen
                    ItemMap.create(zone, 374, 1, 0, 0, -1);
                case 88 -> //4 sao đen
                    ItemMap.create(zone, 375, 1, 0, 0, -1);
                case 89 -> //5 sao đen
                    ItemMap.create(zone, 376, 1, 0, 0, -1);
                case 90 -> //6 sao đen
                    ItemMap.create(zone, 377, 1, 0, 0, -1);
                case 91 -> //7 sao đen
                    ItemMap.create(zone, 378, 1, 0, 0, -1);
            }
        }
    }
