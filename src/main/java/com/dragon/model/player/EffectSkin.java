...
public class EffectSkin {
    ...
    // private long lastTimeltdb; thonk
...
//            updateHalloween();
    ...
    private void updateCTHaiTac() {
        if (this.player.setClothes != null && this.player.setClothes.ctHaiTac != -1
            ...
            try {
                ...
                Logger.logException(EffectSkin.class, e, "updateCTHaiTac");
            }
    ...
    private void updateXenHutXungQuanh() {
        try {
            ...
            Logger.logException(EffectSkin.class, e, "updateXenHutXungQuanh");
        }
    }
    ...
    private void updateOdo() {
        try {
            ...
            Logger.logException(EffectSkin.class, e, "updateOdo");
        }
    }
    ...
    private void updateThoBulma() {
        try {
            ...
            Logger.logException(EffectSkin.class, e, "updateThoBulma");
        }
    }
    ...
    private void updateTanHinh() {
        try {
            ...
            Logger.logException(EffectSkin.class, e, "updateTanHinh");
        }
    }
    ...
    private void updateHoaDa() {
        try {
            ...
            Logger.logException(EffectSkin.class, e, "updateHoaDa");
        }
    }
    ...
    private void updateLamCham() {
        try {
            ...
            Logger.logException(EffectSkin.class, e, "updateLamCham");
        }
    }
    ...
    private void updateXChuong() {
        try {
            ...
            Logger.logException(EffectSkin.class, e, "updateXChuong");
        }
    }
    ...
    private void updateMaPhongBa() {
        try {
            ...
            Logger.logException(EffectSkin.class, e, "updateMaPhongBa");
        }
    }
    ...
    //         }
    //     } catch (Exception e) {
    //         Logger.logException(EffectSkin.class, e, "updateHalloween");
    //     }
    // }
