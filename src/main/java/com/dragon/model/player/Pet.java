...
public class Pet extends Player {
    ...
    public void goHome() {
        ...
        new Thread(() -> {
            try {
                ...
                Logger.logException(Pet.class, e, "goHome");
            }
            if (master != null) {
                try {
                    ChangeMapService.gI().goToMap(this, MapService.gI().getMapCanJoin(this, master.gender + 21, -1));
    ...
    private String getTextStatus(byte status) {
        if (this.typePet == 4) {
            return switch (status) {
                case FOLLOW -> "Lũ con người không đủ tư cách để nói chuyện với ta";
                case PROTECT -> "Ta sẽ cho người biết sức mạnh của một vị thần là như thế nào !";
                case ATTACK -> "Ta sẽ thống trị vũ trụ";
                case GOHOME -> "Không lí nào ta lại run sợ bọn con người sao";
                case HTVV -> "Lũ các ngươi làm ta thấy đau rồi ấy haha";
                default -> "Sức mạnh của ta là không có giới hạn";
            };
        }
        return switch (status) {
            ...
            case HTVV -> "Dm sư phụ";
            default -> "Sư phụ ơi con lên cấp rồi";
        };
    }
    ...
    private void fusionEffect(int type) {
        ...
        try {
            ...
            Logger.logException(Pet.class, e, "fusionEffect");
        }
    }
    ...
    public void update() {
        try {
            ...
            Logger.logException(Pet.class, e, "update");
        }
    }
    ...
    public void openSkill2() {
        ...
        // Set thời gian hồi chiêu cho kỹ năng mới (thonk)
        if (skill != null) {
            skill.coolDown = 1000;
        }
