...
import com.dragon.model.player.badges.BadgesService;
import com.dragon.model.player.badges.BagesTemplate;
import com.dragon.core.server.Manager;
import com.dragon.services.func.BuyBackService;
...
import com.dragon.content.shop.TabShop;
...
public class ShopService {
    ...
    // thonk hàm này không được sử dụng nên tạm thời để private, nếu sau này có sử
    // dụng thì sẽ đổi lại thành public
    ...
    private void learnKyNang(Player pl, ItemShop is) {
        ...
        if (pl.BoughtSkill.contains((int) is.temp.id)) {
            Service.gI().sendThongBao(pl, "Bạn đã học kỹ năng này rồi");
            return;
        }
    ...
    private void buyDanhHieu(Player pl, ItemShop is) {
        ...
        // Service.gI().sendThongBao(pl, "Danh hieu not unlocked");
