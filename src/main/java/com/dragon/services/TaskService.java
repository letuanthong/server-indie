...
import com.dragon.consts.ConstTaskBadges;
import com.dragon.content.shop.ItemShop;
            ...
            switch (mob.tempId) {
                ...
                case ConstMob.XEN_CON_CAP_8:
                    if (player.clan != null) {
                        ...
                        if (list.size() >= NMEMBER_DO_TASK_TOGETHER) {
                            // for (Player pl : list) { // Nếu có người chơi cùng clan trong khu vực, mỗi
                            // người sẽ hoàn thành 2 nhiệm vụ
                            switch (mob.tempId) {
                                case ConstMob.XEN_CON_CAP_1:
        ...
        if (TaskService.gI().isCurrentTask(player, idTaskCustom)) {
            ...
            switch (idTaskCustom) {
                ...
                case ConstTask.TASK_8_2:
                    ...
                    // Service.gI().sendThongBao(player, "Bạn đã được hỗ trợ bỏ qua nhiệm vụ Tàu 77,
                    // Thần mèo.");
                    break;
                ...
                case ConstTask.TASK_10_1:
                    ...
                    npcSay(player, ConstNpc.BO_MONG,
                            "Xem ra cậu đã mạnh hơn lần trước tôi gặp rồi đó cậu có muốn thách đấu tại tên Tàu Pảy Pảy không?");
    ...
    public void paySideTask(Player player) {
        if (player.playerTask.sideTask.template != null) {
            if (player.playerTask.sideTask.isDone()) {
                ...
                InventoryService.gI().sendItemBags(player); // Cập nhật lại hành trang
            } else {
