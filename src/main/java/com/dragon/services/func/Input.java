...
import com.dragon.services.GiftCodeService;
...
public class Input {
    ...
    public void doInput(Player player, Message msg) {
        try {
            ...
            switch (player.idMark.getTypeInput()) {
                ...
                case CHANGE_PASSWORD -> Service.gI().changePassword(player, text[0], text[1], text[2]);
                case GIFT_CODE -> GiftCodeService.gI().giftCode(player, text[0]);
                case FIND_PLAYER -> {
    ...
    public void createForm(Player pl, int typeInput, String title, SubInput... subInputs) {
        ...
        try {
            ...
            Logger.logException(Input.class, e, "createForm");
        } finally {
            if (msg != null) {
                msg.cleanup();
            }
