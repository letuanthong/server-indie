...
public class Trade {
    ...
    public void openTabTrade() {
        ...
        try {
            ...
            Logger.logException(Trade.class, ignored, "openTabTrade");
        } finally {
            if (msg != null) {
                msg.cleanup();
            }
    ...
    private void removeItemTrade(Player pl, byte index) {
        ...
        try {
            ...
            Logger.logException(Trade.class, e, "removeItemTrade");
        } finally {
            if (msg != null) {
                msg.cleanup();
            }
    ...
    private boolean isItemCannotTran(Item item) {
        ...
        /**
         * Các loại item không thể giao dịch
         * 27: ???
         * 5: cải trang
         * 6: đậu thần
         * 7: sách skill
        ...
        return switch (item.template.type) {
            case 27 -> item.template.id == 590;
            case 5, 6, 7, 8, 11, 13, 22, 23, 24, 28, 31, 32 -> true;
            default -> false;
        }; 
    }
    ...
    private void closeTab() {
        ...
        try {
            ...
            Logger.logException(Trade.class, e, "closeTab");
        } finally {
            if (msg != null) {
                msg.cleanup();
            }
    ...
    public void lockTran(Player pl) {
        ...
        try {
            ...
            Logger.logException(Trade.class, e, "lockTran");
        } finally {
            if (msg != null) {
                msg.cleanup();
            }
