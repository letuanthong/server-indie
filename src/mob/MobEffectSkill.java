...
public class MobEffectSkill {
    ...
    private void removeStun() {
        ...
        try {
            ...
            Logger.logException(MobEffectSkill.class, e, "Lỗi trong MobEffectSkill removeStun");
        }
    }
    ...
    public void removeThoiMien() {
        ...
        try {
            ...
            Logger.logException(MobEffectSkill.class, e, "Lỗi trong MobEffectSkill removeThoiMien");
        }
    }
    ...
    public void removeBlindDCTT() {
        ...
        try {
            ...
            Logger.logException(MobEffectSkill.class, e, "Lỗi trong MobEffectSkill removeBlindDCTT");
        }
    }
    ...
    public void removeAnTroi() {
        ...
        try {
            ...
            Logger.logException(MobEffectSkill.class, e, "Lỗi trong MobEffectSkill removeAnTroi");
        }
    }
    ...
    public void removeSocola() {
        ...
        try {
            ...
            Logger.logException(MobEffectSkill.class, e, "Lỗi trong MobEffectSkill removeSocola");
        }
    }
    ...
    public void setBinh(Player plAtt, long lastTimeBinh, int timeBinh) {
        ...
        this.isBinh = true;
        this.typeBinh = plAtt.newSkill.typeItem;
        this.playerUseMafuba = plAtt;
        Service.gI().Send_Body_Mob(mob, 1, this.typeBinh == 0 ? 11175 : 11166);
    }
