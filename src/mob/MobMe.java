...
public final class MobMe extends Mob {
    ...
    public MobMe(Player player) {
        ...
        int skillLevel = player.playerSkill.getSkillbyId(12).point;
        this.tempId = SkillUtil.getTempMobMe(skillLevel);
        this.point.maxHp = (int) Math.min(SkillUtil.getHPMobMe(player.nPoint.hpMax, skillLevel), 2_000_000_000);
        this.point.dame = (int) Math.min(SkillUtil.getHPMobMe(player.nPoint.getDameAttack(false), skillLevel), 2_000_000_000);
        this.point.hp = this.point.maxHp;
        this.zone = player.zone;
        this.lastTimeSpawn = System.currentTimeMillis();
        this.timeSurvive = SkillUtil.getTimeSurviveMobMe(skillLevel);
        spawn();
    }
    ...
    public void attack(Player pl, Mob mob, boolean miss) {
        ...
        try {
            ...
            Logger.logException(MobMe.class, e, "Lỗi trong MobMe attack");
        }
    }
    ...
    public void spawn() {
        ...
        try {
            ...
            Logger.logException(MobMe.class, e, "Lỗi trong MobMe spawn");
        }
    }
    ...
    private void removeMobInMap() {
        ...
        try {
            ...
            Logger.logException(MobMe.class, e, "Lỗi trong MobMe removeMobInMap");
        }
    }
    ...
    public void mobMeDie() {
        ...
        try {
            ...
            Logger.logException(MobMe.class, e, "Lỗi trong MobMe mobMeDie");
        }
    }
    ...
    public synchronized void injured(Player plAtt, long damage, boolean dieWhenHpFull) {
        ...
        try {
            ...
            Logger.logException(MobMe.class, e, "Lỗi trong MobMe injured");
        }
    }
