...
public class ToSuKaio extends Npc {
    ...
    public void openBaseMenu(Player player) {
        if (canOpenNpc(player)) {
            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Tập luyện với Tổ sư Kaio sẽ tăng " + Util.formatNumber(TrainingService.gI().getTnsmMoiPhut(player)) + " sức mạnh mỗi phút, có thể tăng giảm tùy vào khả năng đánh quái của con",
