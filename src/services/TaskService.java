                            ...
                            for (Player pl : list) {
                                switch (mob.tempId) {
                                    case ConstMob.HEO_RUNG:
                                        ...
                                        doneTask(pl, ConstTask.TASK_13_1); // Hoàn thành nhiệm vụ TASK_13_1 (nhiệm vụ kế tiếp)
                                        break;
                                    case ConstMob.HEO_DA_XANH:
                                        doneTask(pl, ConstTask.TASK_13_1); // Hoàn thành nhiệm vụ TASK_13_1
                                        doneTask(pl, ConstTask.TASK_13_2); // Hoàn thành nhiệm vụ TASK_13_2 (nhiệm vụ kế tiếp)
                                        break;
                                    case ConstMob.HEO_XAYDA:
                                        doneTask(pl, ConstTask.TASK_13_2); // Hoàn thành nhiệm vụ TASK_13_2
                                        doneTask(pl, ConstTask.TASK_13_3); // Hoàn thành nhiệm vụ TASK_13_3 (nhiệm vụ kế tiếp)
                                        break;
                                }
                            }
                        } else {
                            ...
                            for (Player pl : list) {
                                switch (mob.tempId) {
                                    case ConstMob.BULON:
                                        ...
                                        doneTask(pl, ConstTask.TASK_15_2); // Hoàn thành nhiệm vụ TASK_15_2 (nhiệm vụ kế tiếp)
                                        break;
                                    case ConstMob.UKULELE:
                                        doneTask(pl, ConstTask.TASK_15_2); // Hoàn thành nhiệm vụ TASK_15_2
                                        doneTask(pl, ConstTask.TASK_15_3); // Hoàn thành nhiệm vụ TASK_15_3 (nhiệm vụ kế tiếp)
                                        break;
                                    case ConstMob.QUY_MAP:
                                        doneTask(pl, ConstTask.TASK_15_3); // Hoàn thành nhiệm vụ TASK_15_3
                                        doneTask(pl, ConstTask.TASK_15_4); // Hoàn thành nhiệm vụ TASK_15_4 (nhiệm vụ kế tiếp)
                                        break;
                                }
                            }
                        } else {
