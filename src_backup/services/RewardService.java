        ...
        for (int i = 0; i < num; i++) {
            ...
            if (vip) {
                ...
                if (Util.isTrue(1, 30)) {
                    ...
                    it.itemOptions.add(new Item.ItemOption(77, 17)); // HP
                    it.itemOptions.add(new Item.ItemOption(103, 18)); // Ki
                    // Xác suất 99% thêm option 93
                    if (!Util.isTrue(1, 200)) {
                        it.itemOptions.add(new Item.ItemOption(93, Util.nextInt(3, 15))); // HSD
                    }
                ...
                // Nếu không chọn được vật phẩm từ danh sách VIP thì gọi itemRand để lấy vật
                // phẩm mặc định
                if (it.quantity == 0) {
